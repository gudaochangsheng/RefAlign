...
pipe = WanVideoPipeline.from_pretrained(
    ...
    ModelConfig(path=".../DiffSynthStudio/models/train/wan14b/models_t5_umt5-xxl-enc-bf16.pth"),
    ModelConfig(path=".../DiffSynthStudio/models/train/wan14b/Wan2.1_VAE.pth")],
)
...
video = pipe(
    ...
    negative_prompt="色调艳丽，过曝，静态，细节模糊不清，字幕，风格，作品，画作，画面，静止，整体发灰，最差质量，低质量，JPEG压缩残留，丑陋的，残缺的，多余的手指，画得不好的手部，画得不好的脸部，畸形的，毁容的，形态畸形的肢体，手指融合，静止不动的画面，杂乱的背景，三条腿，背景人很多，倒着走",
    subject_image=[subject_image1, subject_image2, subject_image3],
    seed=42, tiled=True,
    cfg_scale=5.0
)
save_video(video, "video_Wan2.1-T2V-14B-subject3.mp4", fps=16, quality=9)
